              ...
              <a-col :span="24">
                <div class="page-heading">
                  <div>
                    ...
                    <p>3X-UI v{{ displayVersion }} · {{ t('pages.index.systemLoad') }}</p>
                  </div>
                </div>
              </a-col>
              <a-col :span="24">
...
.index-page .ant-layout-sider {
  background: var(--xui-sidebar) !important;
  backdrop-filter: none !important;
  border-right-color: var(--xui-border) !important;
}
...
.index-page .ant-card:hover {
  box-shadow: var(--xui-shadow) !important;
}

.index-page .ant-card-head,
.index-page .ant-card-actions {
  background: transparent !important;
  border-color: var(--xui-border) !important;
}

.index-page .ant-card-body,
.index-page .ant-statistic-title,
.index-page .ant-statistic-content,
.index-page .ant-menu-item,
.index-page .ant-menu-submenu-title {
