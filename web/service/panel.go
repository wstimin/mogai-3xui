...
func (s *PanelService) StartUpdate() error {
	...
	updateScript := fmt.Sprintf("set -o pipefail; %s -fLs https://raw.githubusercontent.com/wstimin/mogai-3xui/main/update.sh | %s", shellQuote(curl), shellQuote(bash))
...
func fetchLatestPanelVersion() (string, error) {
	...
	resp, err := client.Get("https://api.github.com/repos/wstimin/mogai-3xui/releases/latest")
	if err != nil {
		return "", err
	}
